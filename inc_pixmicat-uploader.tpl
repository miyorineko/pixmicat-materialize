...
<b>{$FORM_NAME_TEXT}</b>{$FORM_NAME_FIELD}
<b>{$FORM_EMAIL_TEXT}</b>{$FORM_EMAIL_FIELD}
<b>{$FORM_TOPIC_TEXT}</b>{$FORM_TOPIC_FIELD}{$FORM_SUBMIT}
<b>{$FORM_COMMENT_TEXT}</b>{$FORM_COMMENT_FIELD}
<!--&IF($FORM_ATTECHMENT_FIELD,'<b>{$FORM_ATTECHMENT_TEXT}</b>{$FORM_ATTECHMENT_FIELD}[{$FORM_NOATTECHMENT_FIELD}<label for="noimg">{$FORM_NOATTECHMENT_TEXT}</label>]','')-->
<!--&IF($FORM_CONTPOST_FIELD,'[{$FORM_CONTPOST_FIELD}<label for="up_series">{$FORM_CONTPOST_TEXT}</label>]','')-->
<!--&IF($FORM_ATTECHMENT_FIELD,'','')-->
<!--&IF($FORM_CATEGORY_FIELD,'<b>{$FORM_CATEGORY_TEXT}</b>{$FORM_CATEGORY_FIELD}<small>{$FORM_CATEGORY_NOTICE}</small>','')-->
<b>{$FORM_DELETE_PASSWORD_TEXT}</b>{$FORM_DELETE_PASSWORD_FIELD}<small>{$FORM_DELETE_PASSWORD_NOTICE}</small>
{$FORM_EXTRA_COLUMN}
<div id="postinfo">
<ul>{$FORM_NOTICE}
