...
(function($){
  $.fn.bbcode = function(options){
    ...
    if(options.tag_bold){
      text = text + '<a href="#" id="b" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'bold.png" />';
      }else{
        text = text + '<i class="tiny material-icons">format_bold</i>粗(B) ';
      }
      text = text + '</a>';
    }
    if(options.tag_strikethrough){
      text = text + '<a href="#" id="d" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'strikethrough.png" />';
      }else{
        text = text + '<i class="tiny material-icons">strikethrough_s</i>刪(D) ';
      }
      text = text + '</a>';
    }
    if(options.tag_italic){
      text = text + '<a href="#" id="i" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'italic.png" />';
      }else{
        text = text + '<i class="tiny material-icons">format_italic</i>斜(I) ';
      }
      text = text + '</a>';
    }
    if(options.tag_underline){
      text = text + '<a href="#" id="u" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'underline.png" />';
      }else{
        text = text + '<i class="tiny material-icons">format_underlined</i>底(U) ';
      }
      text = text + '</a>';
    }
    if(options.tag_link){
      text = text + '<a href="#" id="url" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'link.png" />';
      }else{
        text = text + '<i class="tiny material-icons">insert_link</i>連(L) ';
      }
      text = text + '</a>';
    }
    if(options.tag_image){
      text = text + '<a href="#" id="img" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'image.png" />';
      }else{
        text = text + '<i class="tiny material-icons">insert_photo</i>圖 ';
      }
      text = text + '</a>';
    }
	if(options.tag_code){
      text = text + '<a href="#" id="code" title="" class="waves-effect waves-light">';
      if(options.button_image){
        text = text + '<img src="' + options.image_url + 'image.png" />';
      }else{
        text = text + '<i class="tiny material-icons">code</i>程式碼 ';
      }
      text = text + '</a>';
    }
    text = text + '</div>';
