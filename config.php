...
// 附加圖檔限制
define("MAX_KB", 8000); // 附加圖檔上傳容量限制KB (php內定為最高2MB)
define("STORAGE_LIMIT", 1); // 附加圖檔總容量限制功能 (啟動：1 關閉：0)
define("STORAGE_MAX", 700000); // 附加圖檔總容量限制上限大小 (單位：KB)
define("ALLOW_UPLOAD_EXT", 'GIF|JPG|JPEG|PNG|BMP|SWF'); // 接受之附加圖檔副檔名 (送出前表單檢查用，用 | 分隔)

// 連續投稿時間限制
define("RENZOKU", 15); // 連續投稿間隔秒數
define("RENZOKU2", 20); // 連續貼圖間隔秒數
...
define("COMM_MAX", 8000); // 內文接受字數 (UTF-8)
